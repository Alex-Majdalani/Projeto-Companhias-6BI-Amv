...
export function Modal({ isOpen, onClose, title, children, maxWidth }: ModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative bg-white rounded-2xl shadow-2xl w-full ${maxWidth || 'max-w-md'} overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200`}>
